    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("FOL Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About FOL Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  fol-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the FOL in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more info see <a href=\"https://folpay.atlassian.net/wiki/display/DOC/PrivatePay\">https://folpay.atlassian.net/wiki/display/DOC/PrivatePay</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("FOL Core is shutting down...") + "<br /><br />" +
