    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("FOL Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FOL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fol: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About FOL Core"), this);
    aboutAction->setStatusTip(tr("Show information about FOL Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FOL Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FOL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FOL addresses"));
    ...
    openAction->setStatusTip(tr("Open a fol: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FOL Core help message to get a list with possible FOL Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("FOL Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FOL network", "", count));
}
...
{
    QString strTitle = tr("FOL Core"); // default title
