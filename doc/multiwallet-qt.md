...
Only requiring some minor changes is fol.cpp.
...
Changes to fol.cpp
----------------------
fol.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
