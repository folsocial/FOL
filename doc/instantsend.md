...
This mechanism has been integrated into Bitcore-Node-FOL which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/folpay/insight-api-fol#web-socket-api](https://github.com/folpay/insight-api-fol#web-socket-api) 
* API: [https://github.com/folpay/insight-api-fol#instantsend-transactions](https://github.com/folpay/insight-api-fol#instantsend-transactions) 
...
By default, the FOL Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FOL Core daemon:
