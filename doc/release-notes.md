FOL Core version 0.12.1 is now available from:

  <https://www.fol.org/downloads/>
...
FOL was previously known as Darkcoin.
...
FOL Core tree 0.11.x was a fork of Bitcoin Core tree 0.9, Darkcoin was rebranded
to Dash.

FOL Core tree 0.12.0.x was a fork of Bitcoin Core tree 0.10.
